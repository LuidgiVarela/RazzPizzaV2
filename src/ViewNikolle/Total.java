...
public class Total extends javax.swing.JFrame {
    ...
    public void mostrarResumo(double total, List<String> itens) {
        jTextField1.setText(String.format("R$ %.2f", total));  // exibe total formatado

        jTextArea1.setText("");  // limpa o conteúdo da área de texto
